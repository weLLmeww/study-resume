...
## Functionality
- Interactable header with clickable links nu(number, Telegram, Gmail)
- Sections "Технические навыки", "Обо мне", "Опыт работы", "Образование", "Дополнительная информация"
- Contact form-plug
...
```
git clone https://github.com/weLLmeww/study-resume
cd resume
```
and open index.html
